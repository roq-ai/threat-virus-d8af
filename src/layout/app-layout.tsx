...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['security-officer'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Data', path: '/data', entity: 'data', service: AccessServiceEnum.PROJECT, icon: FiDatabase },
    { name: 'Website', path: '/websites', entity: 'website', service: AccessServiceEnum.PROJECT, icon: FiGlobe },
